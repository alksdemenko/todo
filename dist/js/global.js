...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__todo_list_TodoList__ = __webpack_require__(329);



new __WEBPACK_IMPORTED_MODULE_1__todo_list_TodoList__["a" /* default */]();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions__ = __webpack_require__(330);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var TodoList = function () {
    ...
    _createClass(TodoList, [{
        ...
        value: function addNewTask(e) {
            e.preventDefault();
            var inputValue = this.textHolder.value;

            if (inputValue.length > 0) {
                __WEBPACK_IMPORTED_MODULE_1__actions__["a" /* addNewTask */]({
                    text: inputValue,
                    checked: false,
                    editMode: false,
                    id: this._setId()
        ...
        key: 'changeTaskName',
        value: function changeTaskName(id, e) {
            e.preventDefault();
            var newTaskValue = e.target.firstChild.value;

            if (newTaskValue.length > 0) {
                __WEBPACK_IMPORTED_MODULE_1__actions__["d" /* changeTaskName */](id, newTaskValue);
            }
        }
    }, {
        key: 'removeTask',
        value: function removeTask(id) {
            __WEBPACK_IMPORTED_MODULE_1__actions__["e" /* removeTask */](id);
        }
    }, {
        key: 'setTaskStatus',
        value: function setTaskStatus(id) {
            __WEBPACK_IMPORTED_MODULE_1__actions__["f" /* setTaskStatus */](id);
        }
    }, {
        key: 'applyEditingMode',
        value: function applyEditingMode(id) {
            __WEBPACK_IMPORTED_MODULE_1__actions__["b" /* applyEditingMode */](id);
        }
    }, {
        key: 'cancelEditingMode',
        value: function cancelEditingMode(id) {
            __WEBPACK_IMPORTED_MODULE_1__actions__["c" /* cancelEditingMode */](id);
        }
    }, {
        key: 'render',
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return addNewTask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return removeTask; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return setTaskStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return applyEditingMode; });
